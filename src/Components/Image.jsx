    ...
    <section className="showcase">
        <div className="container-fluid p-0">
            <div className="row g-0">
                <div className="col-lg-6 order-lg-2 text-white showcase-img" ><img src="src/assets/img/bg-showcase-1.jpg" alt="..."/></div>
            ...
            <div className="row g-0">
                <div className="col-lg-6 text-white showcase-img" ><img src="src/assets/img/bg-showcase-2.jpg" alt="..." /></div>
            ...
            <div className="row g-0">
                <div className="col-lg-6 order-lg-2 text-white showcase-img"><img src="src/assets/img/bg-showcase-3.jpg" alt="..." /></div>
                <div className="col-lg-6 order-lg-1 my-auto showcase-text">
